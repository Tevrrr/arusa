					...
					<div className=' md:w-1/2 flex justify-center  px-4 pt-14 pb-10 md:!pt-56 md:!pb-40'>
						<div className=' max-w-[25.5rem]'>
							...
							<p className='TextRegular mt-12'>
								...
								P.U. (Polyurethane) With its entire structure
								painted in wood, it offers a lot of elegance to
								your environment and when cleaning is very easy,
								as it is washable and light for movement. Enough
								of receiving visitors and not having a place to
								accommodate them. With the chair, your days as a
				...
				<div className='w-full max-w-screen-xl overflow-hidden flex flex-col md:flex-row bg-opal text-cloudy'>
					...
					<div className='flex flex-col gap-14 justify-between items-center grow border-r p-4 md:pt-12 md:pb-32 '>
						...
						<p className='TextRegular max-w-md px-2 text-center'>
							...
							stands out for its noble and innovative materials,
